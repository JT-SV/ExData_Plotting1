...
# This script is run directly by sourcing (source("plot3.R")), not a function call, so that 
...
# Select only what will be used in the plots
...
D_plot <- D[c("DateTime","Sub_metering_1","Sub_metering_2","Sub_metering_3")]
...
# Main plot window - no display yet
with(D_plot,plot(DateTime,Sub_metering_1,main="",type="n",xlab="",ylab="Energy sub metering"))
